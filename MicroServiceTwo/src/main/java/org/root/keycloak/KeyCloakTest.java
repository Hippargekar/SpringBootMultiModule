...
public class KeyCloakTest {
    ...
    public static void main(String[] args) {
        ...
        KeyCloakTest test = new KeyCloakTest();
...
//            userRepresentation = usersResourceDtl().search("abc@example.com").getFirst();
    ...
    public List<RoleRepresentation> getUserRoles(String userId, String realmName) {
        return this.getUser(userId, realmName).roles().realmLevel().listAll();
    }
